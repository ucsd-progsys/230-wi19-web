...
{-@ lem_ss_det :: c1:_ -> s1:_ -> c2:_ -> s2:_ -> c2':_ -> s2':_ 
              -> Prop (SStep c1 s1 c2  s2 ) 
              -> Prop (SStep c1 s1 c2' s2') 
              -> { c2 == c2' && s2 == s2' }
  @-}
lem_ss_det :: Com -> State -> Com -> State -> Com -> State -> SStep -> SStep -> Proof 
lem_ss_det _ _ _ _ _ _ (SAssign x a s) (SAssign {}) 
  = ()
lem_ss_det _ _ _ _ _ _ (SSeq1 c s)     (SSeq1 {}) 
  = ()
lem_ss_det _ _ _ _ _ _ (SSeq1 {})      (SSeq2 c1 c1' c2 s s' c1_c1') 
  = lemma_sstep_skip c1 s c1' s' c1_c1' 
lem_ss_det _ _ _ _ _ _ (SSeq2 c1 c1' c2 s s' c1_c1') (SSeq2 _ c1'' _ _ s'' c1_c1'') 
  = lem_ss_det c1 s c1' s' c1'' s'' c1_c1' c1_c1''
lem_ss_det _ _ _ _ _ _ (SSeq2 c1 c1' c2 s s' c1_c1') (SSeq1 {})
  = lemma_sstep_skip c1 s c1' s' c1_c1' 
lem_ss_det _ _ _ _ _ _ (SIfT b c1 c2 s) (SIfT {}) 
  = ()
lem_ss_det _ _ _ _ _ _ (SIfF b c1 c2 s) (SIfF {}) 
  = () 
lem_ss_det _ _ _ _ _ _ (SWhile b c s) (SWhile {}) 
  = ()
